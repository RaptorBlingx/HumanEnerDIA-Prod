...
-- ============================================================================
-- 4. Document multi-energy source tracking
-- ============================================================================

\echo '→ Documenting multi-energy source tracking...'

COMMENT ON TABLE energy_sources IS 'Energy source catalog for electricity, natural gas, compressed air, steam, and other energy carriers tracked by the platform.';

\echo '✓ energy source metadata documented'
\echo ''
