...
CREATE INDEX IF NOT EXISTS idx_esf_energy_source ON energy_source_features(energy_source_id);
CREATE INDEX IF NOT EXISTS idx_esf_source_table ON energy_source_features(source_table);
CREATE INDEX IF NOT EXISTS idx_esf_regression ON energy_source_features(is_regression_feature) WHERE is_regression_feature = true;
